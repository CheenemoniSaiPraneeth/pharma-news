"""
Pharma Intelligence Dashboard — FastAPI Backend
Reads brief_*.json files and serves them via REST API
"""
...
MODALITY_QUERIES = {
    ...
    "molecular_glues":       "molecular glue PROTAC TPD degrader",
    "gene_editing":          "CRISPR gene editing Cas9",
}

def load_brief(modality: str) -> dict | None:
    """Load brief_<modality>.json if it exists."""
...
def get_next_run_date(modality: str) -> str:
    """Calculate next date this modality will run."""
...
async def lifespan(app: FastAPI):
    print("✅ Pharma Intelligence Dashboard started")
    yield
...
def get_modalities():
    """Return summary for all 4 modalities."""
    result = []
...
def get_modality_brief(modality: str):
    """Return full brief for a modality."""
